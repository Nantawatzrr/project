...
import DataAppointment from "../../components/branchAdmin/DataAppointment";
...
const Drawer = styled(MuiDrawer, {
  ...
  backgroundColor: '#FFF', // Add this line for background color
  color:'#000000',
  ...(open && {
    ...openedMixin(theme),
    "& .MuiDrawer-paper": {
  ...
  return (
    <div className="bg">
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar
          position="fixed"
          sx={{ backgroundColor: "white", color: 'black' , boxShadow:10 }}
        >
          <Toolbar>
            <IconButton
              color="inherit"
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          {menudata == "Appointment" && <DataAppointment />}
        </Box>
      </Box>
    </div>
  );
